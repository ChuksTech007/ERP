 ...
 * from './stock-catalog.js' directly — taking them from here would drag
 * better-sqlite3 into the browser bundle. */
export { CATEGORIES, BASE_UNITS, MOVEMENT_LABELS, formatQuantity } from './stock-catalog.js';
import { CATEGORIES, BASE_UNITS, formatQuantity } from './stock-catalog.js';
